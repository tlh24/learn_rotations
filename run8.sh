...
python rotate.py -o 8 -l 16 -c 1 -s "$s_value" -m "$m_value" & 
python rotate.py -o 10 -l 16 -c 1 -s "$s_value" -m "$m_value" &
python rotate.py -o 12 -l 16 -c 1 -s "$s_value" -m "$m_value" &
python rotate.py -o 14 -l 16 -c 1 -s "$s_value" -m "$m_value" &
wait
